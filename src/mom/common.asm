...
;--------------------------------------------
;--------------------------------------------
; Patch: PLY_AKG_INITを呼ぶときに
; レジスタを全てPUSH
; PLY_AKG_INITからかえってきたときに
; レジスタを全てPOPする
;--------------------------------------------
COMMON_AKG_INIT:
...
COMMON_AKG_PLAY:
    ...
    ld a, (PLY_AKG_EVENT)
    or a
    jr z, COMMON_AKG_PLAY_SkipSetFlag

    ld a, 1
    ld (WK_AKGSOUND_END), a

COMMON_AKG_PLAY_SkipSetFlag:
