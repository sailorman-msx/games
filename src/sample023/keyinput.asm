...
KeyInputProc_JumpNow:

    ; ジャンプ中はキー入力を許可しない
    ld a, (WK_JUMPCNT)
    cp $FF
    jr nz, KeyInputProc_KeyInCancelAtJump

KeyInputProc_LadderNow:
    ...
    ld a, b
    cp 3
    jr z, KeyInputProc_KeyInCancel
    cp 7
    jr z, KeyInputProc_KeyInCancel

    jr KeyInputProc_End

KeyInputProc_KeyInCancelAtJump:
