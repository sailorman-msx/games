...
; クリア画面の背景
defb "                                " ; + 0
defb "     CONGRATULATIONS.           " ; + 1
defb " YOU HAVE PASSED THROUGH        " ; + 2
defb " THE DOOR TO HEAVEN.            " ; + 3
defb " ",$22,"I SEE A DAZZLING LIGHT !",$22,"     " ; + 4
defb " SEE YOU AGAIN IN THE NEXT LIFE." ; + 5
defb "                                " ; + 6
defb "           -FIN-                " ; + 7
defb " .............................. " ; + 8
defb "                                " ; + 9
...
defb 20, 29 ; テレポート後のビューポートMAP座標(X, Y)
defb  7,  5 ; テレポート後のプレイヤー座標(X, Y)
defb  0,  0 ; 未使用（予備）
...
defb 17, 30 ; テレポート後のビューポートMAP座標(X, Y)
defb  5, 15 ; テレポート後のプレイヤー座標(X, Y)
defb  0,  0 ; 未使用（予備）
